                ...
                <div className="rounded-md flex flex-col gap-8 my-5">
                  <div className='mx-2 p-5 shadow-[#f58442] rounded-md shadow'>
                    ...
                    <form onSubmit={handleSubmitProposal}>
                      ...
                      <button type="submit"
                        className="text-white bg-[#425BF5] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center"
                      >
                        Submit Proposal
                      </button>
                    </form>
              ...
              <div>
                ...
                {isModalOpen && (
                  <div className="fixed inset-0 bg-gray-500 bg-opacity-75 flex items-center justify-center z-50">
                    <div className="bg-white p-5 rounded-lg w-11/12 md:w-8/12 h-[600px] md:h-auto overflow-scroll relative">
