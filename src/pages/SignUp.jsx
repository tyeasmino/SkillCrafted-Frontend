                    ...
                    <div class="grid grid-cols-2 md:gap-6">
                        <div class="relative flex items-center z-0 w-full mb-5 group">
                            <input type="radio" 
                                ...
                                onChange={handleChange}
                                />
                            <label for="skillCrafter" class="w-full py-4 ms-2 text-sm font-medium text-gray-900  ">Skill Crafter</label>
                        </div>
                        <div class="relative flex items-center z-0 w-full mb-5 group">
                            <input 
                                type="radio" 
                                ...
                                onChange={handleChange}
                                />
                            <label for="skillSeeker" class="w-full py-4 ms-2 text-sm font-medium text-gray-900">Skill Seeker</label>
                        </div>                        
                    </div>    
