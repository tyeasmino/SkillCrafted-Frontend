...
const SkillSeekerProfile = () => {
        ...
        const fetchProfile = async () => {
            try {
                ...
                const res = await axios.get(
                    `https://skillcrafted-backend.vercel.app/skillSeeker/skill-seekers/${user.sk}`,
                    {
                        headers: {
    ...
    useEffect(() => {
        const fetchDesignations = async () => {
            try {
                const res = await axios.get("https://skillcrafted-backend.vercel.app/skillSeeker/designation/");
