                ...
                <div>                    
                    <form class="text-center flex flex-col md:flex-row items-center max-w-lg gap-3  ">    
                        <div class="relative w-full">
                            ...
                            <input type="text" id="voice-search" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full ps-10 p-2.5" placeholder="What are you looking for?" required />
