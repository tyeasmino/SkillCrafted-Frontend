    ...
    return (
        <div>
            <form class="m-5 md:mx-48 md:my-20" onSubmit={handleUpdateProfile}>
                    ...
                    <div className="w-full md:w-1/4">
                        ...
                        <div className="relative z-0 w-full mb-5 group">
                            ...
                            <label
                                ...
                                className="peer-focus:font-medium absolute text-sm text-gray-500   transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 peer-focus:text-blue-600   peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6"
                            >
                ...
                <button
                    type="submit"
                    class="text-white bg-[#425BF5] hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center "
                >
                    Update
                </button>
            </form>
